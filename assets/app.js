...
const PROFESSION_DECISIONS = [
  {
    ...
    decree: 'قرار وزاري رقم 132249 وتاريخ 1447/9/17هـ (2026/4/5م)', pct: 100, minEmployees: 1,
  ...
  },
  {
    ...
    pct: 60, minEmployees: 3, effective: '2026/04/19م', note: 'يُحتسب على مستوى الكيان عند وجود 3 عاملين فأكثر في المهن المستهدفة.',
  ...
  },
  {
    ...
    pct: 70, minEmployees: 3, effective: '2026/05/31م', note: '',
  ...
  },
  {
    ...
    pct: 60, minEmployees: 3, effective: '2026/04/19م', note: 'لا يُحتسب السعودي إن قل أجره الخاضع للتأمينات عن 5,500 ريال؛ ملف الموظفين الحالي لا يحتوي الأجر لذلك الرقم الرسمي من قوى هو الأدق.',
  ...
  },
  {
    ...
    pct: 40, minEmployees: 5, effective: 'تدريجي من 2025/10/27م حتى 70% على مدى 5 سنوات', note: 'يشترط الاعتماد المهني وحد أدنى للأجر؛ الحساب النصي تقديري ما لم تُدخل أرقام قوى الرسمية.',
  ...
  },
  {
    ...
    pct: 30, minEmployees: 5, effective: '2026/06/30م', note: 'يُحتسب على مستوى الكيان عند وجود 5 مهندسين فأكثر، والحد الأدنى للأجر المحتسب 8,000 ريال مع متطلبات الاعتماد المهني.',
  ...
  },
  {
    ...
    pct: 70, minEmployees: 1, effective: 'نافذ حسب الدليل المرفق', note: '70% على مستوى الكيان، والحد الأدنى للأجر المحتسب 5,500 ريال.',
  ...
  },
  {
    ...
    pct: 40, minEmployees: 3, effective: 'المرحلة الثانية 40% من 1446/06/11هـ', note: 'يُحتسب على مستوى الكيان عند وجود 3 عاملين فأكثر، والحد الأدنى للأجر المحتسب 6,000 ريال.',
    professions: ['مدير اتصالات','مدير هندسة اتصالات','مدير إدارة مشاريع','أخصائي إدارة مشاريع','مهندس إدارة مشاريع']
  }
];

// قرار خاص بمنافذ البيع (يُطبق على مستوى المنفذ/الوردية وليس على مسميات وظيفية فردية)
const OUTLET_DECISION = {
  title: 'منافذ بيع الجملة والتجزئة — نشاط "مواد الإعمار والبناء"',
